...
%package runtime
Summary:        Runtime-only files for rmw package
Requires:       ros-rolling-ros-workspace-runtime
BuildRequires:  ros-rolling-ament-cmake-ros-devel
BuildRequires:  ros-rolling-ament-cmake-version-devel
...
%if 0%{?with_tests}
BuildRequires:  ros-rolling-ament-cmake-gmock-devel
...
%description runtime
Runtime-only files for rmw package
...
for f in \
    ...
    /opt/ros/rolling/share/rmw/cmake/ \
    /opt/ros/rolling/share/rmw/package.dsv \
    /opt/ros/rolling/share/rmw/package.xml \
; do
...
%exclude /opt/ros/rolling/share/rmw/cmake
%exclude /opt/ros/rolling/share/rmw/package.dsv
%exclude /opt/ros/rolling/share/rmw/package.xml
